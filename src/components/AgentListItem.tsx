...
export const AgentListItem = ({
  ...
  return (
    <div className="group relative flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-lg bg-white/50 dark:bg-gray-900/50 shadow-sm transition-all duration-300 hover:shadow-lg dark:shadow-gray-900/10 hover:dark:shadow-gray-900/20 backdrop-blur-[2px] hover:backdrop-blur-[4px] hover:-translate-y-0.5 gap-4 sm:gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 lg:gap-12 px-0 sm:px-4 mt-4 sm:mt-0 w-full sm:w-auto">
        <div>
      ...
      <div className="flex items-center gap-2 mt-4 sm:mt-0 w-full sm:w-auto justify-start sm:justify-end">
